...
if uploaded_files:
    ...
    cleaning_option = st.selectbox("Pilih Jenis Cleaning:", ["Cleaning Dataset Pelanggan", "Cleaning Dataset Income"])
    ...
    if st.button("🫧 Pembersihan Data"):
        ...
        for selected_dataset in selected_datasets:
            ...
            if cleaning_option == "Cleaning Dataset Income":
                cleaned_df = clean_data_incomes([df_to_clean])
                file_name = "data_incomes_bersih.xlsx"
            ...
            if cleaning_option == "Cleaning Dataset Pelanggan":
                cleaned_df = clean_data_pelanggan(df_to_clean)
                file_name = "data_pelanggan_bersih.xlsx"
                cleaned_dfs.append(cleaned_df)  # Simpan DataFrame yang sudah dibersihkan
                all_data= pd.concat(cleaned_dfs, ignore_index=True)
